...
export default function EntryPage() {
    ...
    return (
        <main className="h-screen overflow-y-hidden w-full flex justify-center items-center px-4 sm:px-6 py-12 max-w-5xl lg:max-w-full lg:px-20 mx-auto">
            <div className="w-full flex flex-col gap-10 lg:gap-16 items-center">
